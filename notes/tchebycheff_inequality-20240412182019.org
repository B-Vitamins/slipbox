...
#+CAPTION: Clock summary at [2024-04-12 Fri 18:39]
| Headline                   | Time   |
|----------------------------+--------|
| *Total time*               | *0:17* |
|----------------------------+--------|
...
Note that \(n \leqslant 1\) is trivially true. Tchebycheff's in equality dictates bounds for an integral beyond the distance \(n\sigma\) from the mean for /any/ arbitrary PDF. In fact, /any/ even cumulant will do, you need not stick to the variance
